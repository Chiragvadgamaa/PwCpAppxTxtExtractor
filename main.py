...
API_ID = int(os.environ.get("API_ID", 29940427))
API_HASH = os.environ.get("API_HASH", "b0390f6a1bceaa5ed4c62bb6f7d62820")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8937469405:AAG5t8cOmdauW5b1QipNZvxtqQl_CQ7L1uU")
